...
const SuccessfulHospitalRegistration: React.FC = () => {
    return (
        <div className='backgroundPale textBlue flex flex-col fixed inset-0 items-center justify-center'>
            <div className='textClickBlue text-5xl font-bold top-10 absolute textClickBlue'>Thank You!</div>
            <div className='textBlue absolute md:top-32 top-40'>
